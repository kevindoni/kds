...
echo -e "==============================="
echo -e "Proxy Support For Edukasi , Imclass & Telkomsel Opok"
echo -e "==============================="
echo -e "PAYLOAD WS Http     :"
echo -e "GET / HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "bug:2082@$Login:$Pass"
echo -e ""
echo -e "PAYLOAD WS SSL/TLS  :"
echo -e "GET wss://bug/ HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "OR"
echo -e "CONNECT wss://bug/ HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "==============================="
